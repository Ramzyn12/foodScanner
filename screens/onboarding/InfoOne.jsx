  ...
  return (
    ...
    <View style={styles.container}>
      <View style={styles.contentContainer}>
        ...
        <Text style={styles.subtitleText}>Foods such as:</Text>
        <View style={styles.imageCardsContainer}>
          <ImageCard svg={<SeedOils />} text="Seed Oils" />
          <ImageCard svg={<FastFood />} text="Fast Food" />
          <ImageCard svg={<VeganBurger />} text="Substitutes" />
        </View>
