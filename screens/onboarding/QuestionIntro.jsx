  ...
  return (
    <View style={[styles.container, {backgroundColor: themedColours.primaryBackground[theme]}]}>
      ...
      <View style={{ alignItems: "center", gap: 20 }}>
        <HumanOutline color={themedColours.primaryText[theme]} />
        <Text style={[styles.title, {color: themedColours.primaryText[theme]}]}>A few quick questions</Text>
        <Text style={[styles.description, {color: themedColours.primaryText[theme]}]}>
      ...
      >
        <Animated.View style={[styles.button, {backgroundColor: themedColours.primary[theme]}]} sharedTransitionTag="greenButton">
          <Animated.Text style={[styles.buttonText, {color: themedColours.primaryBackground[theme]}]}>Begin</Animated.Text>
          <Svg
