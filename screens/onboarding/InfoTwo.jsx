    ...
    <View style={[styles.container, {backgroundColor: themedColours.primaryBackground[theme]}]}>
      <View style={styles.contentContainer}>
        ...
        <View style={styles.imageCardsContainer}>
          <ImageCard svg={<Cancer color={themedColours.primaryText[theme]} />} text="Cancer" />
          <ImageCard svg={<HeartDisease color={themedColours.primaryText[theme]} />} text="Heart Disease" />
          <ImageCard svg={<Dementia color={themedColours.primaryText[theme]} />} text="Dementia" />
        </View>
