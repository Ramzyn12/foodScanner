...
const WeekDayProgress = ({
  ...
  const chosenDateObj = chosenDate
    ? new Date(chosenDate)
  ...
  return (
    <View
      style={[
        ...
        showUnderline && {
          borderBottomWidth: 4,
          borderBottomColor: themedColours.primary[theme],
        },
      ]}
    >
      <View style={styles.weekDayTop}>
        <Text
          style={[
            [styles.weekDayText, { color: themedColours.primaryText[theme] }],
            dayType === "current" && { color: themedColours.primary[theme] },
          ]}
        >
        ...
        <Text
          style={[
            [styles.weekDayNumber, { color: themedColours.primaryText[theme] }],
            dayType === "current" && { color: themedColours.primary[theme] },
          ]}
        >
      ...
      {dayType === "past" && diaryDayState === "processed" && (
        ...
        <GreyFail
          ...
          crossSize={13}
          colorCross={themedColours.primaryBackground[theme]}
          circleSize={30}
        />
      )}
      {dayType === "past" &&
